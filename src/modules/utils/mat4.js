...
export var m4 = {
    ...
    initCameraMatrix : function(camAngle) {
    ...
    cameraRotate: function(angleInRadians) {
      return m4.multiply(m4.initCameraMatrix(angleInRadians), m4.translation(0, 0, this.cameraRad));
    },

    cameraZoom: function(radius) {
      this.cameraRad = radius;
      return this;
    },
